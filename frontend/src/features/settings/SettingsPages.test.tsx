...
import { testCurrentUser, testRegularUser } from "../../shared/test/fixtures";
...
describe("SettingsPages", () => {
  it("shows profile information", async () => {
    ...
    expect(screen.getByText("系统超级用户")).toBeInTheDocument();
  });
...
type TestUser = typeof testCurrentUser | typeof testRegularUser;
